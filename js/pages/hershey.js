       ...
       var hershey = jQuery.parseJSON(result);
        ...
        if (hershey.count > 0) {
            ...
            jQuery.each(hershey.data, function(x, data) {
                $("#hershey_data tbody").append('<tr><td>' + data.TransDate +'</td><td><a href="' + data.Id + '" id="' + data.Id + '" class="edit_hershey" data-transactiondate="' + data.TransDate + '" data-licplate="' + data.MAX_LicensePlateNumber + '" data-batch="' + data.BatchNumber + '" data-production="' + data.ProdId + '" data-description="' + data.Description + '" data-quantity="' + data.QtyGood + '" data-uomdenominator="' + data.UOMDenominator + '" data-uom="' + data.UOM + '">' + data.LicPlate + '</a></td><td>' + data.MaterialNumber + '</td><td>' + data.BatchNumber + '</td><td>' + data.ProdId + '</td><td>' + data.Description + '</td><td>' + data.QtyGood +'</td><td>' + data.UOM +'</td></tr>');
            });
        } else {
