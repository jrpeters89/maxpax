    ...
    $.get("/src/shipments.php?act=list&user_token=" + user_token, function (result) {
        ...
        if (shipments.count > 0) {
            ...
            jQuery.each(shipments.data, function (x, psId) {
                $("#shipments_list").append('<div id="slip_id_' + psId.PackingSlipId + '" class="table-responsive"><table id="slip_id_table_' + psId.PackingSlipId +'" class="table_sortable"><thead><tr><th>Packing Slip #</th><th>Ship Date</th><th>Item #</th><th>Description</th><th>Sale Order #</th><th>Customer Ref</th></tr></thead><tbody></tbody><tfoot></tfoot></table>');
