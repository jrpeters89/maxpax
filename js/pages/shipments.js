        ...
        if (shipments.count > 0) {
            ...
            jQuery.each(shipments.data, function (x, psId) {
                ...
                jQuery.each(psId, function (z, det) {
                    $("#slip_id_" + psId.PackingSlipId + "_lot tbody").append('<tr><td>' + det.Lot + '</td><td class="text_right">' + det.ExpirationDate + '</td><td class="text_right">' + det.Delivered + '</td><td>' + det.UOM + '</td></tr>');
                });
            });
