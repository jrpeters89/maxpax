function shippingData(user_token) {
	...
	$.get("/src/shipments.php?act=list&user_token="+user_token,function(result) {
		...
		if(shipments.count > 0) {
			$("#shipments_list").html('<table class="table sortable"><thead><tr><th>Item</th><th>Description</th><th class="text_right">Lot</th><th>BBD</th><th class="text_right">Qty</th><th class="text_right">USP Order #</th><th class="text_right">Customer Order #</th></tr></thead><tbody></tbody><tfoot></foot></table>');
