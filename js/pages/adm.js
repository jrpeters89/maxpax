function inventoryTransactions(user_token) {
    ...
    $.get("/src/inv_trans.php?act=list&user_token="+user_token,function(result) {
        ...
        if(inventory.count > 0) {
            $("#inv_trans_list").html('');
            $("#inv_trans_list").append('<link rel="stylesheet" href="//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css">');
            $("#inv_trans_list").append('<script src="//code.jquery.com/jquery-1.10.2.js"></script>');
            $("#inv_trans_list").append('<script src="//code.jquery.com/ui/1.11.4/jquery-ui.js"></script>');
